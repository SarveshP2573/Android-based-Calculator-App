...
public class MainActivity extends AppCompatActivity {
    ...
    buttonDot, buttonAdd, buttonSub, buttonMultiply, buttonDivide, buttonRemainder, buttonClear, buttonOFF, buttonEqual;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonRemainder = findViewById(R.id.remainder);
        ...
        buttonRemainder.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                allCalculations();
                currentSymbol = REMAINDER;
                outputDisplay.setText(decimalFormat.format(firstValue) + "R");
                inputDisplay.setText(null);
            }
        });
    ...
    private void allCalculations(){
        if(!Double.isNaN(firstValue)){
            ...
            if (currentSymbol==ADDITION)
                ...
                firstValue = this.firstValue / secondValue;
            else if (currentSymbol == REMAINDER)
                firstValue = this.firstValue % secondValue;
        }else{
            try{
